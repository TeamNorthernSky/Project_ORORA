...
/// <summary>
/// JC 원본 FogHidableClipPassFeature를 KJ_Work로 복제한 버전.
/// </summary>
public class KJ_FogHidableClipPassFeature : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    private class Pass : ScriptableRenderPass
    {
        ...
        private readonly ProfilingSampler profilingSampler = new ProfilingSampler("KJ_FogHidableClipPass");
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            int fogLayer = KJ_FogRenderLayer.HidableLayerIndex;
            if (fogLayer < 0) return;
