Shader "Custom/KJ/FogOfWar"
{
    Properties
    {
        ...
        [Toggle] _DebugBinaryLayerCut ("Debug Binary Layer Cut", Float) = 0
        _DebugVisibleThreshold ("Debug Visible Threshold", Range(0, 1)) = 0.99
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float _DebugBinaryLayerCut;
                float _DebugVisibleThreshold;
            CBUFFER_END
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                float2 gridUV = saturate((worldPos.xz + _GridWorldOffset) * _GridWorldSize.zw);
                ...
                if (_DebugBinaryLayerCut > 0.5)
                {
                    float binaryVisible = step(_DebugVisibleThreshold, visLow);
                    cellFog = 1.0 - binaryVisible;
                }
